...
# === CARGA PARÁMETROS PARA LOCALIZAR RUNS EXTREMOS DE FA ===
...
guardar_heatmap(diff_abs, f"Diferencia absoluta - fa_threshold", "diff_abs_fa.png")
guardar_heatmap(diff_rel, f"Diferencia relativa (%) - fa_threshold", "diff_rel_fa.png")
...
# Guardar CSV
csv_path = os.path.join(ruta_output, "resumen_diferencias_fa.csv")
