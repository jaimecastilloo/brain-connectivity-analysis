...
# === CARGA PARÁMETROS PARA LOCALIZAR RUNS EXTREMOS DE TURNING ANGLE ===
...
guardar_heatmap(diff_abs, f"Diferencia absoluta - turning_angle", "diff_abs_turning.png")
guardar_heatmap(diff_rel, f"Diferencia relativa (%) - turning_angle", "diff_rel_turning.png")
...
# Guardar CSV
csv_path = os.path.join(ruta_output, "resumen_diferencias_turning.csv")
